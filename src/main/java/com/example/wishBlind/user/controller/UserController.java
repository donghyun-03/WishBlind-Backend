...
/**
 * 마이페이지 API (프로필 이미지 · 알림 설정).
 * 회원 가입/로그인/이메일·비번 변경은 auth 파트에서 처리한다.
 */
@Tag(name = "User", description = "마이페이지 API (프로필 · 알림 설정)")
@RestController
...
public class UserController {
    ...
    @Operation(summary = "정보 수정 완료", description = "닉네임·프로필 이미지 + 알림 설정(ON/OFF)을 저장.")
    @PutMapping("/{id}")
